...
-- =============================================================================
-- 17. CITAS (historial de citas/tareas vinculadas a recursos del CRM)
-- =============================================================================
-- Cada cita/tarea agendada via agendarCita/crearTareaVinculada se persiste aquí.
-- Fuente del historial por recurso; Google sigue siendo la fuente de la agenda.
-- Los eventos/tareas creados sin vínculo NO generan fila. (migración 019)
