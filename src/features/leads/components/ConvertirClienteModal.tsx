      ...
      >
        ...
        <div className="flex items-center justify-between px-5 sm:px-9 pt-5 sm:pt-7 pb-4 sm:pb-5 border-b border-black/5">
          <div className="min-w-0 pr-3">
            <h2 className="font-roxborough text-xl sm:text-2xl text-gray-900">Convertir a cliente</h2>
            <p className="text-xs text-gray-500 truncate">{lead.nombre} — {lead.email}</p>
          </div>
          <button
            type="button"
            onClick={onClose}
        ...
        <div className="px-5 sm:px-9 py-5 sm:py-7 space-y-6">
          ...
          <Section title="Datos fiscales (para facturación)">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-4">
              ...
              <Field label="WEB DE LA EMPRESA" value={form.web_url} onChange={(v) => setForm({ ...form, web_url: v })} placeholder="https://…" />
