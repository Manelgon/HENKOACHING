    ...
    <div className="bg-white pt-24 font-raleway">
      ...
      <section className="px-6 md:px-12 py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="font-roxborough text-2xl md:text-4xl text-gray-900 mb-12 leading-tight">Lo que me guía</h2>
      ...
      <section className="bg-white py-24 px-6 md:px-12 text-center">
        <h2 className="font-roxborough text-2xl md:text-3xl text-gray-900 mb-6">¿Trabajamos juntos?</h2>
        <Link
          href="/contacto"
